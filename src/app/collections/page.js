          ...
          <div className={styles.modal}>
            <div className={styles.modalContent} onClick={e => e.stopPropagation()}>
              ...
              <form onSubmit={handleCreate} className={styles.form}>
                <input
                  type="text"
                  placeholder="Nombre (ej: LaLiga 2026)"
                ...
                <div className={styles.formRow}>
                  <input
                    ...
                    onChange={e => setNewCollection(p => ({ ...p, category: e.target.value }))}
                    className={styles.input}
                  />
                  <input
                    type="number"
                    ...
                    onChange={e => setNewCollection(p => ({ ...p, year: e.target.value }))}
                    className={styles.input}
                  />
                </div>
                <select
                  value={newCollection.visibility}
                  onChange={e => setNewCollection(p => ({ ...p, visibility: e.target.value }))}
                  className={styles.input}
                >
              ...
              <Link key={col.id} href={`/collections/${col.id}`} className={styles.card}>
                ...
                <div className={styles.cardBody}>
                  ...
                  <div className={styles.cardStats}>
                    <span>{col.total_items || 0} elementos</span>
                  </div>
                </div>
                <button
